 ...
 *     tags: [Auth]
 *     summary: Login user
 *     description: Login a user and return JWT token and refresh token
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *     description: Use a refresh token to get a new JWT token
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *     description: Verify the token sent to the user's email for password reset
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *     description: Reset the user's password using a valid token and new password
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
